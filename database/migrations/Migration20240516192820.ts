...
export class Migration20240516192820 extends Migration {

  async up(): Promise<void> {
    this.addSql('alter table "dataset" alter column "last_updated" type timestamptz(25) using ("last_updated"::timestamptz(25));');

    this.addSql('alter table "datafile" add column "unique" boolean not null;');
  ...
  async down(): Promise<void> {
    this.addSql('alter table "datafile" drop column "unique";');
